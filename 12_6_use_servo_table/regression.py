...
# y = np.array([0.080, 5.900, 10.843, 11.880, 11.401, 12.199]) # speed vector
# y = np.array([0.080, 6.617, 7.494, 7.255, 7.653, 6.776]) # speed vector
y = np.array([0.080, 5.421, 11.400, 14.988, 16.024, 16.104]) # speed vector
